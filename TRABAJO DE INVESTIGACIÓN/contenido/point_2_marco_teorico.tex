...
La robótica en el ámbito medico no es un caso reciente, este viene acumulándose en la última década a través del crecimiento de investigación y desarrollo en ingeniería, informática y ciencias de la salud. 

Los primeros en desarrollar este modelo de robots asistentes se encargo de hacerlo la NASA (National Aeronautics and Space Administration) y la DARPA (Defense Advanced Research Project Administration), con su unico objetivo de reemplazar a un cirujano en situaciones complejas, como los programas espaciales, en el campo de batalla y en zonas de catástrofes. En estos primeros modelos la separación del paciente del cirujano y del resto del equipo es el elemento clave, es decir, hablamos de la telecirugía.
Informacion obetenida por: \cite{capitan_cirugia_robotica}.

Robots como Robodoc y Da Vinci fueron pioneros en la aplicación de la robótica en el quirófano, actuando como colaboradores del cirujano. Aun así, al estar en etapas de desarrollo, continúan evolucionando para convertirse en sistemas más ergonómicos, eficientes y capaces de ejecutar intervenciones novedosas que amplíen las destrezas y opciones actuales del cirujano. Informacion de: \cite{opensurg2013robotica}.
...
En 1987 Mouret realizó la primera colecistectomía laparoscópica, marcando un hito en la historia de la CMI (Cirugia minimamente invasiva). Desde entonces el abordaje laparoscópico y mínimamente invasivo se ha consolidado en todas las disciplinas quirúrgicas. La siguiente información se obtuvo de \cite{capitan_cirugia_robotica}.

En 1995 Frederick Moll y Robert Younge fundaron la empresa Intuitive Surgical Inc (Sunnyvale, California, USA) desarrollando un proyecto completo de robótica quirúrgica  con su primer prototipo denominado Lenny. El parrafo leido se extrajo de \cite{camarillo2004robotic}.
...
\begin{figure}[h]
    ...
    \label{fig:1}
    \begin{flushleft}
       \textit{Nota.} Extraido de https://makeblock.com.ar/robot-puma. 
    \end{flushleft}
\end{figure}
...
\begin{figure}[h]
    ...
    \label{fig:2}
    \begin{flushleft}
       \textit{Nota.} Extraido de \cite{gonzalez2005robotica}]. 
    \end{flushleft}
\end{figure}
...
Informacion obtenida de \cite{gonzalez2005robotica}.


\subsection{Investigación en Cibernética y Biónica (Mitad del siglo XX)}

La investigación en cibernética y biónica durante la mitad del siglo XX representó un hito fundamental en el desarrollo de la robótica aplicada a la medicina. La cibernética, que estudia los sistemas de control y comunicación en animales y máquinas, junto con la biónica, que busca imitar procesos biológicos en sistemas artificiales, sentaron las bases para la creación de robots capaces de asistir en intervenciones médicas con precisión y eficacia. Este avance facilitó el diseño de dispositivos que mejoran las habilidades humanas, especialmente en cirugías complejas, donde la precisión y el control son cruciales. Así, las bases teóricas y tecnológicas de la cibernética y biónica permitieron dar el salto hacia la robótica médica moderna, integrando tecnología avanzada para complementar la labor de los profesionales de la salud.

En esta época, las investigaciones propiciaron la incorporación de robots en procedimientos quirúrgicos, dando origen a la telecirugía y a la cirugía mínimamente invasiva, donde los robots actúan como extensiones de la destreza del cirujano. El uso de robots en la medicina mejoró la precisión, redujo el margen de error humano derivado del cansancio o temblores y permitió realizar intervenciones con una miniaturización antes inimaginable. Esta evolución tecnológica, impulsada por la cibernética y la biónica, abrió camino a sistemas robóticos como el da Vinci Surgical System, que hoy son cruciales en especialidades como la cirugía cardíaca, neurocirugía y procedimientos pediátricos, demostrando cómo los conceptos del siglo XX se materializaron en herramientas médicas revolucionarias.

Además, la unión de la cibernética con la robótica biónica no solo facilitó la realización de cirugías con alta precisión, sino que también sentó las bases para futuros avances en la medicina personalizada y en la integración de prótesis inteligentes. La combinación de sensores y sistemas computarizados derivados de esta investigación permite desarrollar dispositivos capaces de interactuar con el cuerpo humano de manera compleja y adaptable, mejorando considerablemente la calidad de vida de pacientes con discapacidades o enfermedades crónicas. En resumen, los esfuerzos científicos de mitad del siglo XX en cibernética y biónica fueron el cimiento para la revolución tecnológica que actualmente convierte a los robots en aliados indispensables dentro del sector salud.
